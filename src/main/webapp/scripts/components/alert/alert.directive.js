        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('climbtrackerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-climbtrackerApp-error');
                                var entityKey = httpResponse.headers('X-climbtrackerApp-params');
                                if (errorHeader) {
